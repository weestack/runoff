...
SOURCES=lexer.c parser.c runoff.c ast.c prettyprint.c symbol.c typechecker.c buildsymboltable.c auxiliary.c codegen.c removeNestedDecls.c constraints.c

# What headers do we have?
HEADERS=ast.h phases.h symbol.h codegen.h
